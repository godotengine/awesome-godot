...
- [Saltmire Transitions](https://github.com/saltmire/saltmire-transitions) - One-line scene transitions: fade, iris circle, directional wipes, and pixelate dissolve. Awaitable API, aspect-correct shaders, MIT.
