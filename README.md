...
- [GodotDiscordSDK](https://github.com/LennyPhoenix/GodotDiscordSDK) - A GDNative plugin that adds support for the Discord Game SDK functionality without recompiling the engine.
