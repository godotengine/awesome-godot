...
- [Godot iBoxDB](https://github.com/iboxdb/aspnet-cross-platform-db/tree/master/Godot) - GDScript wrapper for iBoxDB, making it easy to use iBoxDB database as data storage in GDScript (Godot Mono version).
