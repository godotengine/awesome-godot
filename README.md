...
- [Saltmire FX](https://github.com/saltmire/saltmire-fx) - One-line 2D sprite shader effects: dissolve, outline, hit-flash, freeze, and hologram. Free (MIT), no dependencies, awaitable API.
